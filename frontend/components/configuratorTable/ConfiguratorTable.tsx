...
export function ConfiguratorTable() {
  ...
  console.log(searchTableName, isSearchTableOpen)
  return (
    <>
          ...
          <div className={styles["configurator-table"]}>
            ...
            <button
              ...
              onClick={(e: React.MouseEvent<HTMLElement>) => {
                ...
                setSearchTableName(e.currentTarget.id);
              }}
            >
              <div className={styles["row-title-container"]}>
      ...
      {isSearchTableOpen && <SearchComponents setIsSearchTableOpen={setIsSearchTableOpen} searchTableName={searchTableName} />}
    </>
  );
}
